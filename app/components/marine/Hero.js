  ...
  return (
    <section className='w-full h-[65vh] min-h-[250px] md:min-h-[500px] max-w-[2000px] px-5  md:px-10   relative flex justify-center items-end'>
        ...
        <motion.div
            ...
            className='pl-2 md:pl-0 text-left md:text-center text-gray-50 pb-6 lg:pb-10'
            >
            <p className=' heading-sub uppercase leading-tight tracking-[3.6px] pb-2 lg:pb-4'>Totem Software</p>    
            ...
            <motion.p 
              ...
              className='heading-sub absolute normal-case font-normal pt-2 pl-[2px] md:pl-4 text-white left-0 leading-relaxed text-left'>with specialists in custom Boat Platforms and Marine Websites</motion.p>
              </motion.span>
            </h1>
        </motion.div>
        <motion.div
