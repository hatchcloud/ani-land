...
function TeamPhoto() {
  return (
    <motion.div 
        ...
        <div className='w-full h-full px-10 md:px-16'>
        ...
        <h2 className='text-xl md:text-3xl leading-[90%] font-extrabold max-w-[1000px]' >Founded in 2009, our Costa Rica-based team values IT professionals with strong soft skills for <span className='text-[#AFF3DC] '>seamless integration 
        and success. </span></h2>
        </div>
